...
from python.common.config import SCREENSHOT_DIR, ensure_project_dirs
from python.io_utils.write_target_json import build_target_payload, write_target_json
from python.simulation.pybullet_scene import create_scene
from python.vision.detect_color_target import annotate_detection, detect_red_target
from python.vision.homography import load_default_homography, pixel_to_board
